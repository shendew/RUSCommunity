...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterViewHolder> {
    ...
    public SliderAdapter(List<SliderData> mSliderItems, boolean sliderr) {
    ...
    public SliderAdapterViewHolder onCreateViewHolder(ViewGroup parent) {
        View inflate;
        if (sliderr){
            inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_layout, null);
        }else {
            inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_layout, null);
        }
